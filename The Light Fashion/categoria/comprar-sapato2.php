            ...
            <section>
                ...
                <div class="card1">
                    ...
                    <div class="card-body">
                      ...
                      <div class="clearfix">
                        <img src="../img/3.5.jpg" class="col-md-6 float-md-end mb-3 ms-md-3" alt="...">
                        <p> Vans Old Skool</p>
                        <b>Quantidade / Preço: </b>
                        <select id="quantidade" name="quantidade" required>
                          <option value="1" selected>1 / 18.000 KZ</option>
                          <option value="2">1 / 44,37 USD</option>
                          <option value="3">1 / 42,10 €</option>
                        </select>
                        <br><br>
