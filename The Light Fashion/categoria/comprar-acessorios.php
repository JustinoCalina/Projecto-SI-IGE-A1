<html>
    <head>
        <title>The Light Fashion | Acessorios</title>
        <meta charset="utf-8">
        <!-- Bootstrap CSS -->
            ...
            <section>
                ...
                <div class="card1">
                    ...
                    <div class="card-body">
                      ...
                      <div class="clearfix">
                        <img src="../img/2.1.jpg" class="col-md-6 float-md-end mb-3 ms-md-3" alt="...">
                        <p>Conjunto de Pastas da Zara</p>
