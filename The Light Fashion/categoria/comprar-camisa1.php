            ...
            <section>
                ...
                <div class="card1">
                    ...
                    <div class="card-body">
                      ...
                      <div class="clearfix">
                        <img src="../img/1.6.jpg" class="col-md-6 float-md-end mb-3 ms-md-3" alt="...">
                        <p>Tchert Feminina</p>
                        <b>Quantidade / Preço: </b>
                        <select id="quantidade" name="quantidade" required>
                          <option value="1" selected>1 / 4.000 KZ</option>
                          <option value="2">1 /  9,86 USD</option>
                          <option value="3">1 / 9,36 €</option>
                        </select>
                        <br><br>
