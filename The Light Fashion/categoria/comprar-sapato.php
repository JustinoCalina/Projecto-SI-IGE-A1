            ...
            <section>
                ...
                <div class="card1">
                    ...
                    <div class="card-body">
                      ...
                      <div class="clearfix">
                        <img src="../img/3.1.jpg" class="col-md-6 float-md-end mb-3 ms-md-3" alt="...">
                        <p> Sapato Social Mocasange</p>
                        <b>Quantidade / Preço: </b>
                        <select id="quantidade" name="quantidade" required>
                          <option value="1" selected>1 / 15.000 KZ</option>
                          <option value="2">1 / 36,98 USD</option>
                          <option value="3">1 / 35,08 €</option>
                        </select>
                        <br><br>
