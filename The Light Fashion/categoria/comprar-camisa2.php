<html>
    <head>
        <title>The Light Fashion | Tchert</title>
        <meta charset="utf-8">
        <!-- Bootstrap CSS -->
            ...
            <section>
                ...
                <div class="card1">
                    ...
                    <div class="card-body">
                      ...
                      <div class="clearfix">
                        <img src="../img/1.4.jpg" class="col-md-6 float-md-end mb-3 ms-md-3" alt="...">
                        <p>Tchert Casual</p>
                        <b>Quantidade / Preço: </b>
                        <select id="quantidade" name="quantidade" required>
                          <option value="1" selected>1 / 3.000 KZ</option>
                          <option value="2">1 / 7,40 USD</option>
                          <option value="3">1 / 7,02 €</option>
                        </select>
                        <br><br>
