            ...
            <section>
                ...
                <div class="card1">
                    ...
                    <div class="card-body">
                      ...
                      <div class="clearfix">
                        <img src="../img/1.3.jpg" class="col-md-6 float-md-end mb-3 ms-md-3" alt="...">
                        <p>Fato Social Zara</p>
                        <b>Quantidade / Preço: </b>
                        <select id="quantidade" name="quantidade" required>
                          <option value="1" selected>1 / 50.000 KZ</option>
                          <option value="2">1 / 123,26 USD</option>
                          <option value="2">1 / 116,88 €</option>
                        </select>
                        <br><br>
