            ...
            <section>
                ...
                <div class="card1">
                    ...
                    <div class="card-body">
                      ...
                      <div class="clearfix">
                        <img src="../img/2.3.jpg" class="col-md-6 float-md-end mb-3 ms-md-3" alt="...">
                        <p>Conjusto de Relogio</p>
                        <b>Quantidade / Preço: </b>
                        <select id="quantidade" name="quantidade" required>
                          <option value="1" selected>1 / 40.000 KZ</option>
                          <option value="2">2 / 98,61 USD</option>
                          <option value="3">2 / 93,54 €</option>
                        </select>
                        <br><br>
