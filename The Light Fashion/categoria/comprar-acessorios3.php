            ...
            <section>
                ...
                <div class="card1">
                    ...
                    <div class="card-body">
                      ...
                      <div class="clearfix">
                        <img src="../img/2.5.jpeg" class="col-md-6 float-md-end mb-3 ms-md-3" alt="...">
                        <p>Pandora com peças</p>
                        <b>Quantidade / Preço: </b>
                        <select id="quantidade" name="quantidade" required>
                          <option value="1" selected>1 / 20.000 KZ</option>
                          <option value="2">1 / 49,30 USD</option>
                          <option value="3">1 / 46,78 €</option>
                        </select>
                        <br><br>
