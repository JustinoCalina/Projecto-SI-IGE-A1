            ...
            <section>
                ...
                <div class="card1">
                    ...
                    <div class="card-body">
                      ...
                      <div class="clearfix">
                        <img src="../img/3.3.jpg" class="col-md-6 float-md-end mb-3 ms-md-3" alt="...">
                        <p> Sandalia Moleca</p>
                        <b>Quantidade / Preço: </b>
                        <select id="quantidade" name="quantidade" required>
                          <option value="1" selected>1 / 7.500KZ</option>
                          <option value="2">1 / 18,49 USD</option>
                           <option value="3">1 / 17,55 €</option>
                        </select>
                        <br><br>
