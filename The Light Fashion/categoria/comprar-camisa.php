<html>
    <head>
        <title>The Light Fashion | Camisa</title>
        <meta charset="utf-8">
        <!-- Bootstrap CSS -->
        ...
        <main>
            <section>
                ...
                <div class="card1">
                    ...
                    <div class="card-body">
                      <h5 class="card-title">Comprar Vestuarios</h5>

                      <div class="clearfix">
                        <img src="../img/1.1.jpg" class="col-md-6 float-md-end mb-3 ms-md-3" alt="...">
                        <p>Camisa</p>
