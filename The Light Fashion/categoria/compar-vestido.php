            ...
            <section>
                ...
                <div class="card1">
                    ...
                    <div class="card-body">
                      ...
                      <div class="clearfix">
                        <img src="../img/1.2.jpg" class="col-md-6 float-md-end mb-3 ms-md-3" alt="...">
                        <p>Vestido</p>
                        <b>Quantidade / Preço: </b>
                        <select id="quantidade" name="quantidade" required>
                          <option value="1" selected>1 / 17.500 KZ</option>
                          <option value="2">1 / 43,14 USD</option>
                          <option value="3">1 / 40,92 €</option>
                        </select>
                        <br><br>
