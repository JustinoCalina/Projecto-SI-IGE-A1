            ...
            <section>
                ...
                <div class="card1">
                    ...
                    <div class="card-body">
                      ...
                      <div class="clearfix">
                        <img src="../img/1.5.png" class="col-md-6 float-md-end mb-3 ms-md-3" alt="...">
                        <p>Fato Desportivo Chicago</p>
                        <b>Quantidade / Preço: </b>
                        <select id="quantidade" name="quantidade" required>
                          <option value="1" selected>1 / 30.000 KZ</option>
                          <option value="2">1 / 73,95 USD</option>
                          <option value="3">1 / 70,13 €</option>
                        </select>
                        <br><br>
