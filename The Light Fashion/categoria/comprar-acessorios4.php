            ...
            <section>
                ...
                <div class="card1">
                    ...
                    <div class="card-body">
                      ...
                      <div class="clearfix">
                        <img src="../img/2.4.jpeg" class="col-md-6 float-md-end mb-3 ms-md-3" alt="...">
                        <p>Cinto LV</p>
                        <b>Quantidade / Preço: </b>
                        <select id="quantidade" name="quantidade" required>
                          <option value="1" selected>1 / 15.000 KZ</option>
                          <option value="2">1 / 73,95 USD</option>
                          <option value="3">1 / 70,79 €</option>
                        </select>
                        <br><br>
