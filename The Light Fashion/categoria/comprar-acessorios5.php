<html>
    <head>
        <title>The Light Fashion 2022 | Acessorios</title>
        <meta charset="utf-8">
        <!-- Bootstrap CSS -->
        ...
        <main>
            <section>
                ...
                <div class="card1">
                    ...
                    <div class="card-body">
                      <h5 class="card-title">Comprar Acessorios</h5>

                      <div class="clearfix">
                        <img src="../img/2.6.jpeg" class="col-md-6 float-md-end mb-3 ms-md-3" alt="...">
                        <p>Conjunto de Cordão de Prata</p>
                        <b>Quantidade / Preço: </b>
                        <select id="quantidade" name="quantidade" required>
                          <option value="1" selected>1 / 25.000 KZ</option>
                          <option value="2">1 / 61,63 USD</option>
                          <option value="3">1 / 58,49 €</option>
                        </select>
                        <br><br>
