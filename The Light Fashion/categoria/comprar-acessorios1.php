            ...
            <section>
                ...
                <div class="card1">
                    ...
                    <div class="card-body">
                      ...
                      <div class="clearfix">
                        <img src="../img/2.2.jpeg" class="col-md-6 float-md-end mb-3 ms-md-3" alt="...">
                        <p>Gravatas</p>
                        <b>Quantidade / Preço: </b>
                        <select id="quantidade" name="quantidade" required>
                          <option value="1" selected>1 / 5.000 KZ</option>
                          <option value="2">1 / 12,33 USD</option>
                          <option value="3">1 / 11,69 €</option>
                        </select>
                        <br><br>
