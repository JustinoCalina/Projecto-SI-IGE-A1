            ...
            <section>
                ...
                <div class="card1">
                    ...
                    <div class="card-body">
                      ...
                      <div class="clearfix">
                        <img src="../img/3.4..png" class="col-md-6 float-md-end mb-3 ms-md-3" alt="...">
                        <p> Nike Air Force</p>
                        <b>Quantidade / Preço: </b>
                        <select id="quantidade" name="quantidade" required>
                          <option value="1" selected>1 / 24.000 KZ</option>
                          <option value="2">1 / 59,16 USD</option>
                          <option value="3">1 / 56,13 €</option>
                        </select>
                        <br><br>
